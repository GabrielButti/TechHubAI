...
dados_candidato = {
    "nome": "Maria Silva",
    "titulo_profissional": "Engenheira de Dados",
    "resumo_profissional": "Profissional com 5 anos de experiência em análise e processamento de dados em larga escala. Especializada em ETL, data warehousing e business intelligence com foco em automação de pipelines de dados.",
    ...
    "experiencias": [
        {
            ...
            "descricao": "Desenvolvimento de pipelines ETL escaláveis, otimização de queries SQL e criação de dashboards em Power BI para stakeholders."
        },
        {
            "cargo": "Analista de Dados",
            "empresa": "DataInsight Consulting",
            "descricao": "Análise exploratória de dados, criação de relatórios automatizados e suporte a decisões estratégicas da empresa."
        },
        {
            "cargo": "Estagiária em Análise de Dados",
            "empresa": "StartUp Analytics",
            "descricao": "Coleta, limpeza e análise de dados, criação de visualizações e suporte na manutenção de bancos de dados."
        }
    ],
    "formacao": [
        {
        ...
        {
            "curso": "Especialização em Big Data e Data Science",
